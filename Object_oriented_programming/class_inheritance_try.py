...
class Reptile(Animal):
    def __init__(self,age,weight,height,legs):
        super().__init__(self,age,weight,height)
        self.legs=legs

class Monkey(Mammal):
    fingers=5                 # class attribute stores information that is common across all instances
    def __init__(self,age,weight,height,legs,color):
        super().__init__(self,age,weight,height,legs)
        self.color=color
